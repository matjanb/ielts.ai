...
INSERT INTO tests (title, type, book_number, test_number, difficulty)
VALUES ('Cambridge IELTS — Writing Test 16', 'writing', 1, 16, 'medium')
RETURNING id INTO wt16_id;

INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt16_id, 1, 'Writing Task 1', 'You should spend about 20 minutes on this task. Write at least 150 words.')
RETURNING id INTO s1_id;
...
INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt16_id, 2, 'Writing Task 2', 'You should spend about 40 minutes on this task. Write at least 250 words.')
RETURNING id INTO s2_id;
...
INSERT INTO tests (title, type, book_number, test_number, difficulty)
VALUES ('Cambridge IELTS — Writing Test 17', 'writing', 1, 17, 'medium')
RETURNING id INTO wt17_id;

INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt17_id, 1, 'Writing Task 1', 'You should spend about 20 minutes on this task. Write at least 150 words.')
RETURNING id INTO s1_id;
...
INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt17_id, 2, 'Writing Task 2', 'You should spend about 40 minutes on this task. Write at least 250 words.')
RETURNING id INTO s2_id;
...
INSERT INTO tests (title, type, book_number, test_number, difficulty)
VALUES ('Cambridge IELTS — Writing Test 18', 'writing', 1, 18, 'medium')
RETURNING id INTO wt18_id;

INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt18_id, 1, 'Writing Task 1', 'You should spend about 20 minutes on this task. Write at least 150 words.')
RETURNING id INTO s1_id;
...
INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt18_id, 2, 'Writing Task 2', 'You should spend about 40 minutes on this task. Write at least 250 words.')
RETURNING id INTO s2_id;
...
INSERT INTO tests (title, type, book_number, test_number, difficulty)
VALUES ('Cambridge IELTS — Writing Test 19', 'writing', 1, 19, 'medium')
RETURNING id INTO wt19_id;

INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt19_id, 1, 'Writing Task 1', 'You should spend about 20 minutes on this task. Write at least 150 words.')
RETURNING id INTO s1_id;
...
INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt19_id, 2, 'Writing Task 2', 'You should spend about 40 minutes on this task. Write at least 250 words.')
RETURNING id INTO s2_id;
...
INSERT INTO tests (title, type, book_number, test_number, difficulty)
VALUES ('Cambridge IELTS — Writing Test 20', 'writing', 1, 20, 'medium')
RETURNING id INTO wt20_id;

INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt20_id, 1, 'Writing Task 1', 'You should spend about 20 minutes on this task. Write at least 150 words.')
RETURNING id INTO s1_id;
...
INSERT INTO test_sections (test_id, section_number, title, instructions)
VALUES (wt20_id, 2, 'Writing Task 2', 'You should spend about 40 minutes on this task. Write at least 250 words.')
RETURNING id INTO s2_id;
